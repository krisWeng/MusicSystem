...
<section class="content">
	<section class="widget">
		...
		<div class="content">
			<form action="insertListenServlet" name="form">
				<table id="myTable" border="0" width="100">
					<thead>
						...
						<tr>
							...
							<td><input type="text" id="Unumber" name="Unumber" placeholder="用户编号" required="required" /></td>
							<td><button type="submit" onClick="return check();" class="btn btn-primary btn-block btn-large">确认下载</button></td>
						</tr>
				</table>
			</form>
		</div>
